...
SOURCES = \
	__init__.py \
	CustomMapDownloader.py CustomMapDownloader_dialog.py

PLUGINNAME = CustomMapDownloader

PY_FILES = \
	__init__.py \
	CustomMapDownloader.py CustomMapDownloader_dialog.py

UI_FILES = CustomMapDownloader_dialog_base.ui
...
QGISDIR=C:\Users\abhin\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
