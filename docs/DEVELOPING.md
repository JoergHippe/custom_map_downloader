...
Promotion rule of thumb: keep public-service cases in `experimental_scale_matrix` until they survive repeated Windows/QGIS runs with stable `expected_hashes`. Only then move them into `scale_matrix`.
